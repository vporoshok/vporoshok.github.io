...
Если опираться на архитектуру, описанную в статье [Чистая архитектура на Go](/post/2018/04/clean-architect/), то основная бизнес-логика сервиса должна располагаться в действиях, в пакете `action`. (Подробнее о написании самих действий можно почитать в статье [Действия в действии](/post/2019/08/actions-in-action/).) Каждая команда, предоставляемая сервисом должна по сути 1 к 1 соотносится с действием.
